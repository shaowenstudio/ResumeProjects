 ...
 * 	of this FileIterator relative to the other FileIterators in use by a 
 * 	given instance of the Reducer class.
 */
...
public class FileIterator implements Iterator {
	...
	/**
	 * Constructs a new FileIterator by 
	 * 1)initializing the Scanner passing the given file name to the constructor
	 * 		of the Scanner class and 
	 * 2)setting the index 
	 */
