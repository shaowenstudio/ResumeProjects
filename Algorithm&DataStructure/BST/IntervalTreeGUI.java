...
public class IntervalTreeGUI<T extends Comparable<T>> {
		...
		JPanel contentPane = new JPanel() {
			public void paintComponent(Graphics g) {
				try {
					...
					String background = "C:/Users/Shaowen/workspace2017Spring/CS367/src/image/bg.jpg";
					g.drawImage(ImageIO.read(new File(background)), 0, 0, this.getWidth(), this.getHeight(), this);
	...
	private void initialize(final IntervalNode<T> root) {
		...
		/* set the gui icon */
		String imgName = "C:/Users/Shaowen/workspace2017Spring/CS367/src/image/icon.png";
		Image icon = Toolkit.getDefaultToolkit().getImage(imgName);
