...
public interface IntervalTreeADT<T extends Comparable<T>> {
	 ...
	 * 
	 * <pre>   private void findOverlappingHelper(IntervalNode node, IntervalADT interval, 
	 * 		List<IntervalADT<T>> result)</pre>
	 * 
	 ...
	 * <li>if left subtree's max is greater than or equal to the interval's start, 
	 * 		call findOverlappingHelper in the left subtree.</li>
	 * <li>if right subtree's max is greater than or equal to the interval's start, 
